...
export default function Component() {
  ...
  const restaurant = {
    ...
    menuLink:
      "https://drive.google.com/drive/folders/1l5bvccFsHMWiFN9NmVbCRSvreMMbxTjn?hl=es-419",
    ...
    reviews: [
      ...
      },
      {
        ...
        description:
          "Rico, sustancioso y lleno de sabor. La carne estaba cocinada a la perfección y la salsa de vino era excepcional.",
        rating: 4.5,
      },
      {
        id: "rev3",
